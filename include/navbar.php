...
<header>
    <nav class="navbar navbar-expand-lg navbar-light py-4 nav-menu" style="background-color: #e3f2fd;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="list-inline text-center font-weight-bold text-uppercase ml-auto sm-ml-auto">
                <li class="list-inline-item mt-3 ">
                    <a href="../SD_Project/login.php" class="text-uppercase text-dark mr-3 custom-link-hover mr-3 udline ">Sign in</a>
                </li>
                <li class="list-inline-item mt-3">
                    <a class="text-uppercase text-dark custom-link-hover udline" href="../SD_Project/signup.php">sign up</a>
                </li>
            </ul>
        </div>
    </nav>
